...
@Component({
  ...
  template: `
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              ...
              <p class="text-lg text-neutral-600 leading-relaxed max-w-lg">
                TourneyMatch es la plataforma todo en uno para gestionar torneos de tenis competitivos y aficionados. Desde el registro hasta los resultados en vivo, te tenemos cubierto.
              </p>
            </div>

            <div class="flex flex-col sm:flex-row gap-4">
              <a routerLink="/register" class="px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-lg hover:shadow-lg hover:from-primary-600 hover:to-primary-700 transition-all transform hover:scale-105 text-center">
                Comienza tu torneo
              </a>
              <a routerLink="/tournaments" class="px-8 py-4 bg-white text-primary-600 font-semibold rounded-lg border-2 border-primary-200 hover:border-primary-400 hover:bg-primary-50 transition-all text-center">
                Explorar torneos
              </a>
            </div>
    ...
    <!-- CTA Section -->
    <section class="py-20 md:py-32 bg-gradient-to-r from-primary-600 to-accent-600 relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <p class="text-xl text-white text-opacity-90 max-w-2xl mx-auto">
          Únete a miles de organizadores de torneos y jugadores que usan TourneyMatch hoy.
        </p>
